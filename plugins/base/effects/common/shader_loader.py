...
def shared_shader(name: str, directory: str, filename: str) -> PyCompiledWgsl:
    ...
    return PyCompiledWgsl(name, load_text(os.path.join(directory, filename)), aperio_plugin.image_generator, None)


def compose_common_shader(name: str, modules: list, directory: str, filename: str) -> PyCompiledWgsl:
    ...
    return PyCompiledWgsl.compose_new(
        name, modules, gpu_util.create_naga_module(os.path.join(directory, filename)), aperio_plugin.image_generator
    )
