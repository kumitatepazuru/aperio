...
class PyImageGenerator:
    ...
    def generate_buf(self, builder: PyImageGenerateBuilder, buffer_ptr: builtins.int) -> PyGenerateOutput: ...
    def generate_texture(self, builder: PyImageGenerateBuilder) -> PyGenerateOutput: ...
